...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Filme filme1 = new Filme(0,"GarfieldKart", 93,"Aventura","L","Jorge Ben Jor", "Filmão",LocalDate.parse("15/05/2024", formatter));
        Filme filme2 = new Filme(1,"Esse mesmo", 111,"Suspense","+16","Jorge Ben Jor", "Filmaço",LocalDate.parse("20/04/2024", formatter));
        Filme filme3 = new Filme(2, "Senhor sono", 63, "Terror", "+18", "Kama Pistache", "Show de bola", LocalDate.parse("26/04/2024", formatter));

        Cliente cliente = new Cliente(1, "Nunca vi pedreiro chamado Enzo", "666.666.666.66", LocalDate.parse("02/12/1984", formatter));
        Cliente cliente1 = new Cliente(2, "Ratanja", "433.263.287.36", LocalDate.parse("28/09/1997", formatter));
        Cliente cliente2 = new Cliente(3, "resenhilson da silva", "323.432.423.54", LocalDate.parse("22/12/1944", formatter));
