...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Cliente cliente1 = new Cliente(1, "Ratanja", "433.263.287-36", LocalDate.parse("28/09/2014", formatter));
        ...
        do {
            ...
            switch (i){
                ...
                case 3:
                    ...
                    x = scanner.nextInt();
                    System.out.println(clientes.get(x).getIdade() + " anos tem " + clientes.get(x).getNome());
