...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Cliente cliente = new Cliente(1, "Nunca vi pedreiro chamado Enzo", "666.666.666.66", LocalDate.parse("1984-12-02"));
        Cliente cliente1 = new Cliente(2, "Ratanja", "433.263.287.36", LocalDate.parse("1997-09-28"));
        Cliente cliente2 = new Cliente(3, "resenhilson da silva", "323.432.423.54", LocalDate.parse("1944-12-22"));
